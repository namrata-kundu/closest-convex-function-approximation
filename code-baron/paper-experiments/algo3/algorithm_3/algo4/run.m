...
no_of_pieces = size(f,2)*3;
% no_of_pieces = size(f,2)*10;
[rho,new_pieces,  objective]  = nearest_convex_function_variable_pieces_of_fixed_num(f,pieces,no_of_pieces);
 ...
 [g,g_pieces, num_of_pieces] = decrease_pieces_of_convex_function(simple_rho,simple_rho_pieces, epsilon, @get_nearest_function_with_variable_pieces_of_given_num);
