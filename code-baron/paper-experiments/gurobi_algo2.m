function [rho_vals,new_pieces, sol, objective] = gurobi_algo2(f,pieces)
    yalmip('clear')
...
%         Constraints1 = [Constraints1, con1]:'constraints1';
    ...
    slack_var = sdpvar(1,1,'full');
     ...
     Constraints = [Constraints, slack_var>=0, t==objective+slack_var;];

    %Feed into solver
     
    sol = optimize([Constraints1, Constraints2,Constraints3, Constraints4, Constraints5,Constraints6,Constraints7],t, options)
