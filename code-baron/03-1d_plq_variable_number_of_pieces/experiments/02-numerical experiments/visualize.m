...
function  visualize(f,f_pieces, rho, rho_pieces,g,g_pieces)
...
grid on;
    ...
    %g
    hold on;
    piecewise_rho = build_piecewise_function(g, g_pieces);

     h3 = fplot(piecewise_rho, 'LineWidth', 1.5, 'Color', 	"#77AC30");
grid on;
    hold on;

    % Plotting the boundary points for rho
    plot_boundary_points(g, g_pieces, h3.Color);
end
